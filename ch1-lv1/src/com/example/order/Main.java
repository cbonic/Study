...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        order3.addItem(new OrderItem("ITEM-006", "ORD-2026-003", "PRD-202", "ワイヤレスマウス", 10, 4800));
        order3.addItem(new OrderItem("ITEM-007", "ORD-2026-003", "PRD-203", "メカニカルキーボード", 10, 8900));
