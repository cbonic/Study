...
public class Task2_21 {
    ...
    public static void main(String[] args) {
    	...
    	HashMap<String, String> fruitsArrayList = new HashMap<String, String>();
    	
    	fruitsArrayList.put("orange", "オレンジ");
    	fruitsArrayList.put("grape", "ぶどう");
    	fruitsArrayList.put("apple", "りんご");
    	fruitsArrayList.put("pear", "梨");
    	...
    	{
    		System.out.println(fruitsArrayList.get(key) + "の値段は" + fruitsHashMap.get(key) + "です。");
    	}
