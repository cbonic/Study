...
public class ContractEmployee extends Employee {
    ...
    public ContractEmployee(String employeeId, String name, String deptId, int monthlyWage, LocalDate hireDate, int contractMonths) 
    {
        super(employeeId, name, deptId, monthlyWage, hireDate);
